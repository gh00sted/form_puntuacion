...
<body>
    ...
    <div class="container">
        <h2>Resultados de Búsqueda - <?php echo htmlspecialchars($operario_filtro); ?></h2>
        ...
        <?php else: ?>
            <div class="puntuacion-total-container">
                <p class="puntuacion-total-text">Puntuación Total: <span class="puntuacion-total"><?php echo number_format($puntuacion_total, 2); ?></span></p>
            </div>
            <table border="1">
                <thead>
                    <tr>
